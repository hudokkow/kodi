...
# Fedora build guide
This guide has been tested with Fedora 27 1.6 x86_64. Please read it in full before you proceed to familiarize yourself with the build procedure.
...
```
sudo dnf install wayland-devel waylandpp-devel wayland-protocols-devel
```
