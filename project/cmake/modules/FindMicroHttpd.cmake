...
if(NOT MICROHTTPD_FOUND)
  ...
  set(_microhttpd_INCLUDE_SEARCH_DIRS ${CMAKE_INCLUDE_PATH} /usr/local/include /usr/include)
  set(_microhttpd_LIBRARIES_SEARCH_DIRS ${CMAKE_LIBRARY_PATH} /usr/local/lib /usr/lib)
  ...
  find_path(MICROHTTPD_INCLUDE_DIRS microhttpd.h HINTS ${_microhttpd_INCLUDE_SEARCH_DIRS}
  ...
  find_library(MICROHTTPD_LIBRARIES NAMES ${MICROHTTPD_LIBRARY_NAMES} HINTS ${_microhttpd_LIBRARIES_SEARCH_DIRS}
...
mark_as_advanced(MICROHTTPD_FOUND MICROHTTPD_LIBRARIES MICROHTTPD_DEFINITIONS MICROHTTPD_INCLUDE_DIRS)
