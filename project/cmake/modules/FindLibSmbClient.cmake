...
if(LIBSMBCLIENT_LIBRARIES AND LIBSMBCLIENT_INCLUDE_DIRS)
  ...
  find_path(LIBSMBCLIENT_INCLUDE_DIR NAMES libsmbclient.h PATHS /usr/include
                                                                /usr/local/include
                                                                /opt/local/include
                                                                /sw/include)

  find_library(SMBCLIENT_LIBRARY NAMES smbclient PATHS /usr/lib
                                                       /usr/local/lib
                                                       /opt/local/lib
                                                       /sw/lib)
  ...
  if(SMBCLIENT_FOUND)
    set(LIBSMBCLIENT_LIBRARIES ${LIBSMBCLIENT_LIBRARIES} ${SMBCLIENT_LIBRARY})
  endif()
