...
function(copy_file_to_buildtree file relative)
  ...
  if(NOT ${CORE_SOURCE_DIR} MATCHES ${CMAKE_BINARY_DIR})
    if(VERBOSE)
      message(STATUS "copy_file_to_buildtree - copying file: ${file} -> ${CMAKE_BINARY_DIR}/${CORE_BUILD_DIR}/${outfile}")
    endif()
...
function(core_add_subdirs_from_filelist files)
  ...
  foreach(filename ${files})
    ...
    foreach(subdir ${fstrings})
      ...
      if(VERBOSE)
        message(STATUS "core_add_subdirs_from_filelist - adding subdir: ${CORE_SOURCE_DIR}/${subdir_src} -> ${CMAKE_BINARY_DIR}/${CORE_BUILD_DIR}/${subdir_dest}")
      endif()
  ...
  foreach(filename ${filenames})
    ...
    foreach(line ${fstrings})
      ...
      foreach(opt ${opts})
        if(ENABLE_${opt})
          if(VERBOSE)
            message(STATUS "core_add_optional_subdirs_from_filelist - adding subdir: ${CORE_SOURCE_DIR}/${subdir_src} -> ${CMAKE_BINARY_DIR}/${CORE_BUILD_DIR}/${subdir_dest}")
          endif()
          add_subdirectory(${CORE_SOURCE_DIR}/${subdir_src} ${CORE_BUILD_DIR}/${subdir_dest})
          else()
            if(VERBOSE)
