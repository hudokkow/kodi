...
void CGUIDialogMediaSource::OnPathBrowse(int item)
{
  ...
  if (m_type == "music")
  {
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20240);
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20245);
      share1.m_ignore = true;
      extraShares.push_back(share1);
    }
#endif
    ...
    share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20011);
    share1.m_ignore = true;
    extraShares.push_back(share1);
    ...
    if (CPVRDirectory::HasRadioRecordings())
    {
      ...
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19017); // Recordings
      extraShares.push_back(share1);
    }
    if (CPVRDirectory::HasDeletedRadioRecordings())
    {
      share1.strPath = PVR::CPVRRecordingsPath::PATH_DELETED_RADIO_RECORDINGS;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19184); // Deleted recordings
      extraShares.push_back(share1);
    }
    ...
    if (CServiceBroker::GetSettings().GetString(CSettings::SETTING_AUDIOCDS_RECORDINGPATH) != "")
    {
      ...
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(21883);
      extraShares.push_back(share1);
    }
  }
  else if (m_type == "video")
  {
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20241);
      share1.m_ignore = true;
      extraShares.push_back(share1);
    }
#endif
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20246);
      share1.m_ignore = true;
      extraShares.push_back(share1);
    }
#endif
    ...
    share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20012);
    extraShares.push_back(share1);
  ...
  else if (m_type == "pictures")
  {
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20242);
      share1.m_ignore = true;
      extraShares.push_back(share1);
    }
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20243);
      share1.m_ignore = true;
      extraShares.push_back(share1);
    }
#endif
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20247);
      share1.m_ignore = true;
      extraShares.push_back(share1);
    }
    path.clear();
    ...
    {
      share1.strPath = path;
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20248);
      share1.m_ignore = true;
      extraShares.push_back(share1);
    }
#endif
    ...
    if (CServiceBroker::GetSettings().GetString(CSettings::SETTING_DEBUG_SCREENSHOTPATH) != "")
    {
      ...
      share1.strName = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(20008);
      extraShares.push_back(share1);
    }
  }
...
void CGUIDialogMediaSource::OnPath(int item)
{
  ...
  CGUIKeyboardFactory::ShowAndGetInput(path, CVariant{ CServiceBroker::GetGUI()->GetLocalizeStrings().Get(1021) }, false);
  m_paths->Get(item)->SetPath(path);
...
void CGUIDialogMediaSource::UpdateButtons()
{
  ...
  for (int i = 0; i < m_paths->Size(); i++)
  {
    ...
    if (path.empty()) path = "<" + CServiceBroker::GetGUI()->GetLocalizeStrings().Get(231) + ">"; // <None>
    item->SetLabel(path);
  }
...
void CGUIDialogMediaSource::SetTypeOfMedia(const std::string &type, bool editNotAdd)
{
  ...
  {
    if (type == "video")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10053);
    else if (type == "music")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10054);
    else if (type == "pictures")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10055);
    else if (type == "games")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(35252); // "Edit game source"
    else if (type == "programs")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10056);
    else
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10057);
  }
  else
  {
    if (type == "video")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10048);
    else if (type == "music")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10049);
    else if (type == "pictures")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(13006);
    else if (type == "games")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(35251); // "Add game source"
    else if (type == "programs")
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10051);
    else
      heading = CServiceBroker::GetGUI()->GetLocalizeStrings().Get(10052);
  }
