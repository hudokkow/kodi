      ...
      case DRIVE_OPEN:
        {
          ...
          SetNewDVDShareUrl("D:\\", false, guih->GetLocalizeStrings().Get(502));
          m_isoReader.Reset();
      ...
      case DRIVE_NOT_READY:
        {
          ...
          m_isoReader.Reset();
          SetNewDVDShareUrl("D:\\", false, guih->GetLocalizeStrings().Get(503));
      ...
      case DRIVE_CLOSED_NO_MEDIA:
        {
          // Nothing in there...
          m_isoReader.Reset();
          SetNewDVDShareUrl("D:\\", false, guih->GetLocalizeStrings().Get(504));
