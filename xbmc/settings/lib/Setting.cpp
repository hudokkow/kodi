...
CSettingList::CSettingList(const std::string &id, CSetting *settingDefinition, CSettingsManager *settingsManager /* = nullptr */)
...
CSettingList::CSettingList(const std::string &id, CSetting *settingDefinition, int label, CSettingsManager *settingsManager /* = nullptr */)
  : CSetting(id, settingsManager),
    m_definition(settingDefinition),
    m_delimiter("|"),
    m_minimumItems(0), m_maximumItems(-1)
...
CSettingInt::CSettingInt(const std::string &id, CSettingsManager *settingsManager /* = nullptr */)
  : CSetting(id, settingsManager),
    ...
    m_optionsFiller(nullptr),
    m_optionsFillerData(nullptr)
{ }
...
CSettingInt::CSettingInt(const std::string &id, int label, int value, const StaticIntegerSettingOptions &options, CSettingsManager *settingsManager /* = nullptr */)
  : CSetting(id, settingsManager),
    m_value(value), m_default(value),
    m_min(0), m_step(1), m_max(0),
    m_options(options),
