...
static const translateField fields[] = {
  ...
  { "videoresolution",   FieldVideoResolution,         CDatabaseQueryRule::NUMERIC_FIELD,  nullptr,                                 false, 21443 },
  { "videocodec",        FieldVideoCodec,              CDatabaseQueryRule::TEXTIN_FIELD,   nullptr,                                 false, 21445 },
  { "videoaspect",       FieldVideoAspectRatio,        CDatabaseQueryRule::NUMERIC_FIELD,  nullptr,                                 false, 21374 },
  { "audiochannels",     FieldAudioChannels,           CDatabaseQueryRule::NUMERIC_FIELD,  nullptr,                                 false, 21444 },
                                                 ...
                                                 const CDatabase &db, const std::string &strType) const
{
  ...
  if (strType == "songs")
  {
    ...
    if (m_field == FieldGenre)
      ...
      query = GetField(m_field, strType) + " is nullptr or " + GetField(m_field, strType) + parameter;
  }
  ...
  { // playcount IS stored as nullptr OR number IN video db
        ...
        (m_operator == OPERATOR_LESS_THAN))
    {
      ...
      query = field + " IS nullptr OR " + field + parameter;
    }
  }
  if (query.empty())
