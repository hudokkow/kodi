...
bool CMusicDatabaseDirectory::GetLabel(const std::string& strDirectory, std::string& strLabel)
{
  ...
  if (strLabel.empty())
  {
    ...
    case NODE_TYPE_TOP100:
      strLabel = guih->GetLocalizeStrings().Get(271); // Top 100
      break;
    case NODE_TYPE_GENRE:
      strLabel = guih->GetLocalizeStrings().Get(135); // Genres
      break;
    case NODE_TYPE_SOURCE:
      strLabel = guih->GetLocalizeStrings().Get(39030); // Sources
      break;
    case NODE_TYPE_ROLE:
      strLabel = guih->GetLocalizeStrings().Get(38033); // Roles
      break;
    case NODE_TYPE_ARTIST:
      strLabel = guih->GetLocalizeStrings().Get(133); // Artists
      break;
    case NODE_TYPE_ALBUM:
      strLabel = guih->GetLocalizeStrings().Get(132); // Albums
      break;
    case NODE_TYPE_ALBUM_RECENTLY_ADDED:
    case NODE_TYPE_ALBUM_RECENTLY_ADDED_SONGS:
      strLabel = guih->GetLocalizeStrings().Get(359); // Recently Added Albums
      break;
    case NODE_TYPE_ALBUM_RECENTLY_PLAYED:
    case NODE_TYPE_ALBUM_RECENTLY_PLAYED_SONGS:
      strLabel = guih->GetLocalizeStrings().Get(517); // Recently Played Albums
      break;
    case NODE_TYPE_ALBUM_TOP100:
    case NODE_TYPE_ALBUM_TOP100_SONGS:
      strLabel = guih->GetLocalizeStrings().Get(10505); // Top 100 Albums
      break;
    case NODE_TYPE_SINGLES:
      strLabel = guih->GetLocalizeStrings().Get(1050); // Singles
      break;
    case NODE_TYPE_SONG:
      strLabel = guih->GetLocalizeStrings().Get(134); // Songs
      break;
    case NODE_TYPE_SONG_TOP100:
      strLabel = guih->GetLocalizeStrings().Get(10504); // Top 100 Songs
      break;
    case NODE_TYPE_YEAR:
    case NODE_TYPE_YEAR_ALBUM:
    case NODE_TYPE_YEAR_SONG:
      strLabel = guih->GetLocalizeStrings().Get(652);  // Years
      break;
    case NODE_TYPE_ALBUM_COMPILATIONS:
    case NODE_TYPE_ALBUM_COMPILATIONS_SONGS:
      strLabel = guih->GetLocalizeStrings().Get(521);
      break;
