...
void CNetworkServices::Start()
{
  ...
  if (m_settings.GetBool(CSettings::SETTING_SERVICES_WEBSERVER) && !StartWebserver())
    CGUIDialogKaiToast::QueueNotification(CGUIDialogKaiToast::Warning, guih->GetLocalizeStrings().Get(33101), guih->GetLocalizeStrings().Get(33100));
#endif // HAS_WEB_SERVER
  ...
  if (m_settings.GetBool(CSettings::SETTING_SERVICES_ESENABLED) && !StartJSONRPCServer())
    CGUIDialogKaiToast::QueueNotification(CGUIDialogKaiToast::Warning, guih->GetLocalizeStrings().Get(33103), guih->GetLocalizeStrings().Get(33100));
