...
- (id)init
{
  ...
  if (self)
  {
    ...
    std::string descText    = guih->GetLocalizeStrings().Get(34404) + "\n";
    descText              += guih->GetLocalizeStrings().Get(34405) + "\n";
    descText              += guih->GetLocalizeStrings().Get(34406) + "\n";
    descText              += guih->GetLocalizeStrings().Get(34407) + "\n";
    descText              += guih->GetLocalizeStrings().Get(34408) + "\n";
