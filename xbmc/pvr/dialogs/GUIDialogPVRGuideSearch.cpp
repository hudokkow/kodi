...
void CGUIDialogPVRGuideSearch::UpdateChannelSpin(void)
{
  ...
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19217), EPG_SEARCH_UNSET));
...
{
  std::vector< std::pair<std::string, int> > labels;
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(593),   EPG_SEARCH_UNSET));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19500), EPG_EVENT_CONTENTMASK_MOVIEDRAMA));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19516), EPG_EVENT_CONTENTMASK_NEWSCURRENTAFFAIRS));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19532), EPG_EVENT_CONTENTMASK_SHOW));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19548), EPG_EVENT_CONTENTMASK_SPORTS));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19564), EPG_EVENT_CONTENTMASK_CHILDRENYOUTH));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19580), EPG_EVENT_CONTENTMASK_MUSICBALLETDANCE));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19596), EPG_EVENT_CONTENTMASK_ARTSCULTURE));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19612), EPG_EVENT_CONTENTMASK_SOCIALPOLITICALECONOMICS));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19628), EPG_EVENT_CONTENTMASK_EDUCATIONALSCIENCE));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19644), EPG_EVENT_CONTENTMASK_LEISUREHOBBIES));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19660), EPG_EVENT_CONTENTMASK_SPECIAL));
  labels.push_back(std::make_pair(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(19499), EPG_EVENT_CONTENTMASK_USERDEFINED));
...
void CGUIDialogPVRGuideSearch::UpdateDurationSpin(void)
{
  ...
  for (int i = 1; i < 12*60/5; ++i)
    labels.push_back(std::make_pair(StringUtils::Format(CServiceBroker::GetGUI()->GetLocalizeStrings().Get(14044).c_str(), i*5), i*5));
