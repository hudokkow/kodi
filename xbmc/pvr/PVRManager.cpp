...
void CPVRManager::Process(void)
{
  ...
  CPVRGUIProgressHandler* progressHandler = new CPVRGUIProgressHandler(guih->GetLocalizeStrings().Get(19235)); // PVR manager is starting up
...
bool CPVRManager::LoadComponents(CPVRGUIProgressHandler* progressHandler)
{
  ...
  if (progressHandler)
    progressHandler->UpdateProgress(guih->GetLocalizeStrings().Get(19236), 0); // Loading channels from clients
  ...
  if (progressHandler)
    progressHandler->UpdateProgress(guih->GetLocalizeStrings().Get(19237), 50); // Loading timers from clients

  m_timers->Load();

  /* get recordings from the backend */
  if (progressHandler)
    progressHandler->UpdateProgress(guih->GetLocalizeStrings().Get(19238), 75); // Loading recordings from clients
  ...
  if (progressHandler)
    progressHandler->UpdateProgress(guih->GetLocalizeStrings().Get(19239), 85); // Starting background threads
